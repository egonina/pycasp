...
class GMM(object):
    ...
    def insert_base_code_into_listed_modules(self, names_of_backends):
        ...
        c_base_tpl = AspTemplate.Template(filename=GMM.template_path +"templates/em_base_helper_funcs.mako")
    ...
    def insert_non_rendered_code_into_cuda_module(self):
        ...
        c_base_tpl = AspTemplate.Template(filename=GMM.template_path +"templates/em_cuda_host_helper_funcs.mako")
        c_base_rend  = c_base_tpl.render()
        GMM.asp_mod.add_to_module([Line(c_base_rend)],'c++')
        cu_base_tpl = AspTemplate.Template(filename=GMM.template_path +"templates/em_cuda_device_helper_funcs.mako")
    ...
    def insert_non_rendered_code_into_cilk_module(self):
        ...
        cilk_base_tpl = AspTemplate.Template(filename=GMM.template_path +"templates/em_cilk_helper_funcs.mako")
    ...
    def render_func_variant( self, param_dict, param_val_list, can_be_compiled, backend_name, func_name):
        ...
        if can_be_compiled: 
            c_tpl = AspTemplate.Template(filename='_'.join([GMM.template_path + "templates/em",backend_name,func_name+".mako"]))
