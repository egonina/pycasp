...
boost::python::tuple em_cuda_train${'_'+'_'.join(param_val_list)} (int num_components, 
                                                                   int num_dimensions, 
                                                                   int num_events,
                                                                   int min_iters,
                                                                   int max_iters) {
...
%endif
  ...
  while(iters < min_iters || (iters < max_iters && change > epsilon)) {
    ...
    mstep_means_launch${'_'+'_'.join(param_val_list)}(d_fcs_data_by_dimension,
                                                      d_components,
                                                      d_component_memberships,
                                                      num_dimensions,
                                                      num_components,
...
%endif
    ...
    mstep_covar_launch${'_'+'_'.join(param_val_list)}(d_fcs_data_by_dimension,
                                                      d_fcs_data_by_event,
                                                      d_components,
                                                      d_component_memberships,
                                                      num_dimensions,
